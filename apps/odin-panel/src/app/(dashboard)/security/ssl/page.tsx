                           ...
                           <td className="p-5 text-right pr-8">
                              {!hasSsl ? (
                                <button 
                                  ...
                                  className="bg-[#00A3FF]/10 text-[#00A3FF] hover:bg-[#00A3FF] hover:text-white px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-sm active:scale-95 transition-all flex items-center gap-2 w-full justify-center disabled:opacity-40"
                                >
                                   <span className="material-symbols-outlined text-[16px]">security</span>
                                   {autoSslMutation.isPending ? "Configurando..." : "Auto-SSL"}
                                </button>
                              ) : (
                                <span className="text-[10px] text-emerald-500 font-black uppercase tracking-widest flex items-center justify-end gap-1.5 mr-4">
